...
\SetTitle{SEARCH FOR THE HIGGS BOSON DECAY TO BOTTOM QUARKS\\WHEN PRODUCED IN ASSOCIATION WITH A WEAK VECTOR BOSON}
...
\bibliographystyle{bst/apsrev4-1-custom}
