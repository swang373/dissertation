...
For this analysis, two different machine learning classifiers were considered for the final multivariate discriminant: a gradient boosted decision tree (BDT)\cite{GBDT} and a multilayer perceptron\cite{MLP} or artificial neural network (ANN).
