...
\begin{figure}[htbp]
  \centering
    \includegraphics[width=5in]{images/SMinfographic_image}
    \caption[Standard Model Infographic]{An infographic of the Standard Model depicting the elementary particles and their interactions. \cite{Purcell:1473657}}
\end{figure}
